...
class HotSpotCompilerTests(unittest.TestCase):
    ...
    def test_given_number_of_commit_and_lines_count_then_ordered_by_highest_number_of_commits(self):
    ...
    def test_given_number_of_commits_equal_then_ordered_by_highest_number_of_lines(self):
